...
\begin{frame}{Summary of Systematic Uncertainties}
  ...
  \begin{center}
    ...
    \end{tabular}
    \caption{\label{tab:systematics} Summary of systematic errors.}%from simulation.}
    \end{table}
  \end{center} 
  }
...
\hline
\end{tabular}
    \caption{\label{tab:results} Detailed results.}%from simulation.}
    \end{table}
\end{center}
}
\end{frame}
...
\tiny{$\left[2.2,2.4\right]$} & 4.2 & 4.7 & 4.1 & 4.7 & 5.6 & 6.8 & 6.7 & 6.2 & 7.0 & 10.3 & 171.0 \\
    \end{tabular}
    \caption{\label{tab:covar} Covariance matrix.}%from simulation.}
    \end{table}
  \end{center}
  }
\end{frame}
